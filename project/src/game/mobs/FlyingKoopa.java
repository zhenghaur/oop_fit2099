...
public class FlyingKoopa extends Enemy {
    ...
    /**
     * Constructor to create a Flying Koopa.
     */
    public FlyingKoopa() {
    ...
    /**
     * Returns a new collection of the Actions that Flying Koopa can do to the current Actor.
     *
    ...
    /**
     * Return a display character for the Flying Koopa.
     * @return a char, e.g. 'D' if Flying Koopa is in Dormant state
     */
    @Override
