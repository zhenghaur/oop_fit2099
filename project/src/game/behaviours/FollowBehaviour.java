...
public class FollowBehaviour implements Behaviour {
	...
	/**
	 * Constructor to create a FollowBehaviour to the target Actor
	 * 
	...
	/**
	 * Create and return the MoveActorAction if the target Actor is close by.
	 *
	 ...
	 * @return a MoveActorAction, or null if actor can't do this.
	 */
	@Override
